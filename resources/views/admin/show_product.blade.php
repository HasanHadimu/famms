            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        {{-- <form action="{{ url('/show_product') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-2">
                                <label for="gambar" class="form-label" ></label>
                                <input type="text" class="form-control" name="category" id="kategori" placeholder="Write Name Kategori">
                            </div>

                            <div class="mb-2">
                                <button type="submit" class="btn btn-primary" name="submit" value="Add Category">Tambah Kategori</button>
                            </div>
                        </form> --}}
                    </div>
                        <table id="tabelcari" class="table table-bordered table-striped table-hover text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img src="/product/{{ $product->image }}" width="50">
                                    </td>
                                    <td>
                                        <a class="btn btn-primary" href="{{ url('delete_product', $product->id) }}">delete</a>
                                        <a class="btn btn-danger" href="{{ url('update_product', $product->id) }}">edit</a>
                                    </td>
                                </tr>
                            </tbody>
                            @endforeach
